...
export default function Navbar() {
    ...
    return (
        <>
            {/*{router}*/}
                <Disclosure as="nav" className=" min-w-full  -mt-10 fixed bg-white shadow-sm">
                    {({ open }) => (
                        <>
                                            ...
                                            {navigation.map((item) => (
                                                <Link key={item.name} href={item.href}
                                                        className={classNames(
                                                            item.current ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300',
