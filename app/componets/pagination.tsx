...
// @ts-ignore
export default function Pagination({currentPage, totalPages, hasMorePages, onNext, onPrevious, onChange}) {
    return (
        <nav className="border-t border-gray-200 px-4 flex items-center justify-between sm:px-0 pb-3 ">
